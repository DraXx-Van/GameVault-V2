...
const GameRatingCard = ({ game }) => {
  ...
  const ratingTiers = [
    { id: "masterpiece", title: "Masterpiece", color: "text-primary", icon: "ri-trophy-fill" },
    { id: "exceptional", title: "Exceptional", color: "text-purple-500", icon: "ri-vip-diamond-fill" },
    { id: "recommended", title: "Recommended", color: "text-blue-500", icon: "ri-thumb-up-fill" },
    { id: "mixed", title: "Mixed", color: "text-primary", icon: "ri-meh-fill" },
            ...
            <div className='animate-in fade-in slide-in-from-top-2 duration-300 flex flex-col gap-1'>
              <div className='flex flex-wrap items-center gap-2 mb-1'>
                <p className={`text-3xl font-black ${
                  recommendedPercentage >= 60 ? 'text-green-500' : 
                  recommendedPercentage >= 40 ? 'text-primary' : 
                  'text-red-500'
                }`}>
