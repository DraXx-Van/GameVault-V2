...
const GameCard = ({key,image,name,rating}) => {
  return (
    <div key={key} className='group flex flex-col gap-3 w-[260px] md:w-[280px] hover:translate-y-[-4px] hover:bg-[#1a1b22]/40 border border-white/5 transition-all duration-200 ease-in-out shrink-0 p-3 rounded-xl cursor-pointer bg-[#0c0c0e]'>
